...
_STATE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SELECTIVE', index=1, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_SWITCH.fields_by_name['state'].enum_type = _STATE
_SWITCH.fields_by_name['conditions'].message_type = _CONDITION
