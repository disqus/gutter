...
class TestTruthyCondition(BaseOperator, GutterTestCase):
...
class TestEqualsCondition(BaseOperator, GutterTestCase):
...
class TestBetweenCondition(BaseOperator, GutterTestCase):
...
class TestLessThanCondition(BaseOperator, GutterTestCase):
...
class TestMoreThanOperator(BaseOperator, GutterTestCase):
...
class TestMoreThanOrEqualToOperator(BaseOperator, GutterTestCase):
...
class PercentageTest(PercentTest, GutterTestCase):
...
class PercentRangeTest(PercentTest, GutterTestCase):
